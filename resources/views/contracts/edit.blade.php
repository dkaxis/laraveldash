    ...
    <div class="row">
      <div class="col-md-12">
         @include('client.topbar')
               @include('plans.tabs')
            <h2>Rediger Kommunal Handleplan</h2>
                     ...
                     <div class="col-md-9">
                        <div class="form-group{{ $errors->has('goal') ? ' has-error' : '' }}">
                            <label for="goal" class="control-label">Formål</label>
                                ...
                                <textarea id="goal" type="text" class="form-control" rows="14" name="goal" value="" required autofocus>{!!preg_replace('/<br\s?\/?>/i', '\r\n', $contract->goal)!!}</textarea>
                         ...
                         <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            <label for="description" class="control-label">Beskrivelse</label>
                                ...
                                <textarea id="description" type="text" class="form-control" rows="14" name="description" value=""  >{!!preg_replace('/<br\s?\/?>/i', '\r\n', $contract->description)!!}</textarea>
                         ...
                         <div class="form-group{{ $errors->has('client_goal') ? ' has-error' : '' }}">
                            <label for="client_goal" class="control-label">Den unges ønsker</label>
                                ...
                                <textarea id="client_goal" type="text" class="form-control" rows="14" name="client_goal" value="{{ old('client_goal') }}"  >{!!preg_replace('/<br\s?\/?>/i', '\r\n', $contract->client_goal)!!}</textarea>
                         ...
                         <div class="form-group{{ $errors->has('date_from') ? ' has-error' : '' }}">
                            <label for="date_from" class=" control-label">Start Dato</label>
                                <div class="input-group date form_datetime"  id="datetimepicker_from" data-date="" data-date-format="yyyy-mm-dd">
                                    <input  type="text" class="form-control"  size="16" value="{{ $contract->date_from}}" readonly>
                                     <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                    </div>
                              <input id="date_from" type="hidden" class="form-control" name="date_from" size="16" value="{{ $contract->date_from}}" readonly>    
                          ...
                          <div class="form-group{{ $errors->has('date_to') ? ' has-error' : '' }}">
                            ...
                            <div class="input-group date form_datetime"  id="datetimepicker_to" data-date="" data-date-format="yyyy-mm-dd">
                                    <input  type="text" class="form-control"  size="16" value="{{ $contract->date_to}}" readonly>
                                     <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                    </div>
                              <input id="date_to" type="hidden" class="form-control" name="date_to" size="16" value="{{ $contract->date_to}}" readonly>    
